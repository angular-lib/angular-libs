...
| 11 | **`@ngneat/hotkeys`** | Keyboard shortcuts | Shortcut matching, `allowIn`, help menu, preventDefault, target element. Overlaps `keyboardStateSignal` only as “pressed keys”; it is a command layer, not a key-state sensor. | [npm](https://www.npmjs.com/package/@ngneat/hotkeys), [repo](https://github.com/ngneat/hotkeys) |
